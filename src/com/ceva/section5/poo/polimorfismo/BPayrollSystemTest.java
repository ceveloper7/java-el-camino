...
public class BPayrollSystemTest {
    public static void main(String[] args) {
        ...
        BSalariedEmployee salariedEmployee = null;
        BHourlyEmployee hourlyEmployee = null;
        BCommissionEmployee commissionEmployee = null;
        BBasePlusCommissionEmployee basePlusCommissionEmployee = null;

        try{
             salariedEmployee =
                    new BSalariedEmployee("John", "Smith", "111-11-1111", 900.00);
            hourlyEmployee =
