...
public class LoggingImageViewer {
    public static void main(String[] args)
    {
        EventQueue.invokeLater(() ->
        {
            ...
            System.Logger logger = System.getLogger("com.ceva.core1.ch07.logging");
            // Niveles de mensajes: ERROR, WARNING,INFO,DEBUG, TRACE
...
class ImageViewerFrame extends JFrame
{
    ...
    // Solicitamos un Logger y asignamos un nombre (logger)
    private static System.Logger logger = System.getLogger("com.ceva.core1.ch07.logging");
    ...
    private class FileOpenListener implements ActionListener
    {
        public void actionPerformed(ActionEvent event)
        {
            logger.log(DEBUG, "Entering ImageViewerFrame.FileOpenListener.actionPerformed(%s)",
                    event);
