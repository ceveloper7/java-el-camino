 ...
 */
public class Watch10 extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Clip
        float dnRadius = radius * 0.65f; // day/night radius
        Arc2D arc;
        ...
        testY = (int)(centerY - dnRadius*(1-smoothLen)*Math.sin(Math.toRadians(10)));
        
        testX2 = (int)(centerX - dnRadius*Math.cos(Math.toRadians(10)));
        testY2 = (int)(centerY - dnRadius*Math.sin(Math.toRadians(10)));
        
        testX3 = (int)(centerX - dnRadius*Math.cos(Math.toRadians(10)+smoothLen));
        testY3 = (int)(centerY - dnRadius*Math.sin(Math.toRadians(10)+smoothLen));
        
        testX4 = (int)(centerX - dnRadius*1.05f*Math.cos(Math.toRadians(10)+smoothLen));
        testY4 = (int)(centerY - dnRadius*1.05f*Math.sin(Math.toRadians(10)+smoothLen));
        ...
        createDayNightImage((int)(dnRadius*2));
